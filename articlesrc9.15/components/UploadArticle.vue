			...
			creatArticle(){
				if(this.inputaricletitie!=""){
					if(this.inputarticlecontent!=""){
						if(this.zoneid!=0){
							var Nickname = this.accoountownername;
							var title = this.inputaricletitie;
							var content =this.inputarticlecontent;
							var zoneid = this.zone;
							var headerToken=this.token;
							this.ajax = new XMLHttpRequest();
							this.ajax.open("POST", "http://139.224.255.43:7779/Article/createArticleByNickName?nick_name="+Nickname+"&title="+title+"&content="+content+"&zoneid="+zoneid, true);
