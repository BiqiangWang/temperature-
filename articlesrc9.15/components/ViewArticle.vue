	...
	<div id="ViewArticle-page">
		...
		<div id="ViewArticle-content-container">
			...
			<div id="ViewArticle-content-data">
				...
				&nbsp;&nbsp;&nbsp;
				<span style="margin: 0;">{{articlepraisenum}}</span>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<div id="ViewArticle-collect-logo1"></div>
				&nbsp;&nbsp;&nbsp;
				<span style="margin: 0;"> {{articlecollectnum}}</span>
			</div>
			<div>
	...
	export default {
		   ...
		   data(){
		   	return {
				...
				token:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ3d3ciLCJqdGkiOiI2YTljMTViNC1iNzE4LTQzZjItODFmYi1hNGFmNWQ5NTVjNWUiLCJleHAiOjE2MDAxMzg3MjgsImlzcyI6Imh0dHBzOi8vd3d3LmNuYmxvZ3MuY29tL2NoZW5ndGlhbiIsImF1ZCI6Imh0dHBzOi8vd3d3LmNuYmxvZ3MuY29tL2NoZW5ndGlhbiJ9.-sSa-6E05yJjHs4ONE1-oxITfklxtfDqr6CTBOENdnQ",
				articleid:0,
				accountownerid:0,
				articleownername:"",
				personalsign:"",
	       ...
	       methods:{
			...
			addSonComment(comid){
				if(this.inputcommenttocomment!=""&&this.inputcommenttocomment.length<=10){
					var name=this.accountownername;
					var commentid =comid;
					var comtocom=this.inputcommenttocomment;
					var headerToken=this.token;
				...
				else if(this.inputcommenttocomment==""){
					this.$alert('评论不能为空！！', '警告', {
					          confirmButtonText: '确定'
					        });
				}
				else if(this.inputcommenttocomment.length>10){
					this.$alert('评论不能超过10个字符！！', '警告', {
					          confirmButtonText: '确定'
					        });
				}
